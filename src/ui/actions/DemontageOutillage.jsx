...
import { Webhook, AlertCircle, ChevronRight, ChevronLeft, Check, WebhookOff } from 'lucide-react'
...
function DemontageOutillage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('outillage/fin', form)
  ...
  return (
    <div>
      <CModal title="Montage Outillage" label="Montage Outillage" icon={<WebhookOff />}>
...
export default DemontageOutillage;